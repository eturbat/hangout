...
# -- Posted by toraritte, modified by community. See post 'Timeline' for change history␍
...
pkgs.mkShell {
  ...
  LOCALE_ARCHIVE = if pkgs.stdenv.hostPlatform.isLinux then "${pkgs.glibcLocales}/lib/locale/locale-archive" else "";
}
